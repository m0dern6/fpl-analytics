    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _chipItem(
            'Triple Captain',
            'Use on your highest scoring GW captain',
            Icons.star,
          ...
          _chipItem(
            'Bench Boost',
            'Use when all 15 players have good fixtures',
            Icons.people,
            AppColors.of(context).primary,
          ),
          const SizedBox(height: 8),
          _chipItem(
            'Free Hit',
            'Use in a blank or double gameweek',
            Icons.refresh,
          ...
          _chipItem(
            'Wildcard',
            'Use to completely rebuild your squad',
            Icons.shuffle,
